...
@section('title')
    {{Help::languages('Dashboard')}} ::
@endsection


@section('header')
    <!-- Specific Page Vendor CSS -->
    {!!  Html::style('vendor/assets_admin/vendor/jquery-ui/jquery-ui.css') !!}
    {!!  Html::style('vendor/assets_admin/vendor/jquery-ui/jquery-ui.theme.css') !!}
    {!!  Html::style('vendor/assets_admin/vendor/bootstrap-multiselect/bootstrap-multiselect.css') !!}
    {!!  Html::style('vendor/assets_admin/vendor/morris.js/morris.css') !!}
@endsection
...
@section('footer')
    ...
    {!!  Html::script('vendor/assets_admin/vendor/jquery-ui/jquery-ui.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqueryui-touch-punch/jqueryui-touch-punch.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jquery-appear/jquery-appear.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/bootstrap-multiselect/bootstrap-multiselect.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/flot/jquery.flot.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/flot.tooltip/flot.tooltip.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/flot/jquery.flot.pie.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/flot/jquery.flot.categories.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/flot/jquery.flot.resize.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jquery-sparkline/jquery-sparkline.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/raphael/raphael.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/morris.js/morris.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/gauge/gauge.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/snap.svg/snap.svg.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/liquid-meter/liquid.meter.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/jquery.vmap.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/data/jquery.vmap.sampledata.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/jquery.vmap.world.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.africa.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.asia.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.australia.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.europe.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js') !!}
    {!!  Html::script('vendor/assets_admin/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js') !!}
@endsection

@section('footer_examples')
    <!-- Examples -->
    {!!  Html::script('vendor/assets_admin/javascripts/dashboard/examples.dashboard.js') !!}
@endsection
